 ...
 */
 ...
 #ifndef GHOST_SCHEDULERS_PYTHON_ROUND_ROBIN_ROUND_ROBIN_SCHEDULER_H
 #define GHOST_SCHEDULERS_PYTHON_ROUND_ROBIN_ROUND_ROBIN_SCHEDULER_H
 ...
 namespace ghost {
   ...
   class RoundRobinScheduler : public BasicDispatchScheduler<RoundRobinTask> {
    public:
     ...
     bool SkipForSchedule(const Cpu& cpu);
    ...
    private:
     ...
     bool RunqueueEmpty() const { return run_queue_.empty(); }
     ...
     //std::vector<RoundRobinTask*> run_queue_;
     std::deque<RoundRobinTask*> run_queue_;
     //std::vector<RoundRobinTask*> paused_repeatables_;
     //std::vector<RoundRobinTask*> yielding_tasks_;
     std::deque<RoundRobinTask*> yielding_tasks_;
     //std::vector<RoundRobinTask*> blocked_tasks_;
     std::deque<RoundRobinTask*> blocked_tasks_;
