...
cc_binary(
    name = "agent_round_robin",
    srcs = [
        "schedulers/round_robin/agent_round_robin.cc",
    ],
    copts = compiler_flags,
    visibility = ["//experiments/scripts:__pkg__"],
    deps = [
...
cc_library(
    ...
    srcs = [
        "schedulers/round_robin/round_robin_scheduler.cc",
    ],
    hdrs = [
        "schedulers/round_robin/round_robin_scheduler.h",
    ],
    copts = compiler_flags,
    deps = [
        ":agent",
